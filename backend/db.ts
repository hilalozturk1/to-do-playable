...
const insertSampleUsers = async () => {
  try {
    ...
    const sampleTodos = [
      {
        title: "ToDo 1 for User 1",
        description: "Description for ToDo 1",
        tag: "completed",
        image: "./uploads/pictures/bod_mainImg_01.jpg",
        attachment: "./upload/bod_mainImg_01.jpg",
        user: insertedUsers[0].id,
      },
      {
        title: "ToDo 2 for User 1",
        description: "Description for ToDo 2",
        tag: "ready",
        image: "https://www.ricoh-imaging.co.jp/english/products/q-s1/ex/img/bod_mainImg_02.jpg",
        attachment: "attachment2.pdf",
        user: insertedUsers[0].id,
      },
      {
        title: "ToDo 1 for User 2",
        description: "Description for ToDo 1",
        tag: "completed",
        image: "image3.jpg",
